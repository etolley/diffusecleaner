...
from radionets.simulations.utils import add_noise, add_white_noise

def add_noise(bundle, noise_level = 5):
    """
    Used for adding noise and plotting the original and noised picture,
    if asked. Using noise_level * max(image) as scaling factor.
